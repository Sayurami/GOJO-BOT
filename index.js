...
async function connectToWA() {
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("Gojo💀 installed successful ✅");
      console.log("Gojo💀 connected to whatsapp ✅");

      let up = `Gojo💀 connected successful ✅`;
